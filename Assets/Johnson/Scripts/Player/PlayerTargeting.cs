...
/// <summary>
/// This script allows our player to target object that have the TargetToShoot script on them.
/// </summary>
public class PlayerTargeting : MonoBehaviour
{
    ...
    /// Anything too far away or outside the player's FOV is ignored and not included int the set
    /// of possible targets
    /// </summary>
    ...
    void SetTargetToClosest()
    {
        ...
        for (int i = 0; i < possibleTargets.Count; i++)
        {
            ...
            float d2 = (thing.transform.position - transform.position).sqrMagnitude;
